...
class Scan_Detail(ctk.CTkFrame):
    ...
    def __init__(self, master):
        ...
        self.scan_result_label = ctk.CTkLabel(self.main_top, text="SCAN RESULT: " , font=ctk.CTkFont(size=20, weight="bold"),text_color='White')
        ...
        self.target_entry = ctk.CTkEntry(self.main_entry, width=600, placeholder_text="Search Vunerabilities",)
        self.target_entry.grid(row=0, column=0,sticky="nw",pady=(15, 15))
        current_path = os.path.dirname(os.path.realpath(__file__))
        self.bt_search = ctk.CTkButton(self.main_entry,width=80,height=25,anchor="w", image=ctk.CTkImage(Image.open(current_path + "/assets/icons/search.png"),size=(15, 15)), text=" Search", text_color='white',fg_color='red')
        self.bt_search.grid(row=0, column=1, padx=10, pady=10)
        total_vul = 85
        
        self.total_vul_label = ctk.CTkLabel(self.main_entry, text=str(total_vul) + " vulnerabilities", font=ctk.CTkFont(size=15, weight="bold"),text_color='red')
        self.total_vul_label.grid(row=0, pady=10, padx=(25,5), column=2)
        
        self.main_center = ctk.CTkFrame(self,height=700, width=master.winfo_width(), fg_color='#2b2b2b')
        self.main_center.pack( fill=tkinter.X, expand=True, padx=5)
        self.main_center.grid_columnconfigure((0,1), weight=1)
        self.data_vulnerabilities = ctk.CTkFrame(self.main_center, height = 40,width=750)
        self.data_vulnerabilities.grid(row = 0, column =0, sticky="nw");
        #self.main_center.grid_rowconfigure((), weight=2)
       
        self.header = ctk.CTkFrame(self.data_vulnerabilities, height = 40,width=750, fg_color='gray')
        ...
        self.sev_label = ctk.CTkLabel(self.sev_label_frame, text="Sev", font=ctk.CTkFont(size=15, weight="bold"),text_color='White',fg_color='gray', width=100)
        self.sev_label.grid(row=0, column=1, pady=10, padx=5,sticky="nw")
        
        #name label
        self.name_label_frame = ctk.CTkFrame(self.header,width=300, fg_color='gray', corner_radius=0)
        ...
        self.name_label = ctk.CTkLabel(self.name_label_frame, text="Name", font=ctk.CTkFont(size=15, weight="bold"),text_color='White',fg_color='gray', width=300)
        self.name_label.grid(row=0, column=2, pady=10, padx=5,sticky="nw")
        
        #des label
        self.des_label_frame = ctk.CTkFrame(self.header,width=500, fg_color='gray', corner_radius=0)
        ...
        #count label
        self.count_label_frame = ctk.CTkFrame(self.header,width=50, fg_color='gray', corner_radius=0)
        ...
        self.count_label = ctk.CTkLabel(self.count_label_frame, text="Count", font=ctk.CTkFont(size=15, weight="bold"),text_color='White',fg_color='gray',width=50)
        ...
        for i in range(len(options)):
            self.data = ctk.CTkFrame(self.data_vulnerabilities, height = 40, width=950, fg_color='#d0caca')
            ...
            self.sev_data = ctk.CTkLabel(self.data, text="Sev" + options[i], font=ctk.CTkFont(size=15),text_color='Black',fg_color='#d0caca', width=100)
            ...
            self.des_data = ctk.CTkLabel(self.data, text="Description" + options[i], font=ctk.CTkFont(size=15),text_color='Black',fg_color='#d0caca', width=450)
            self.des_data.grid(row=0, column=3, pady=10, padx=5,sticky="nw")
            self.count_data = ctk.CTkLabel(self.data, text="1", font=ctk.CTkFont(size=15),text_color='Black',fg_color='#d0caca',width=50)
            self.count_data.grid(row=0, column=4, pady=10, padx=5,sticky="nw")
        
        
        # info vulnerabilities  
        self.info_vulnerabilities = ctk.CTkFrame(self.main_center, height = 600,width=350, fg_color='#dc4c4c', bg_color='#dc4c4c')
        self.info_vulnerabilities.grid(row = 0, column =2, padx=15);
        self.info_vulnerabilities.grid_columnconfigure((0), weight=1)
        self.scan_detail_label = ctk.CTkLabel(self.info_vulnerabilities, text="Scan details", font=ctk.CTkFont(size=20, weight="bold"),anchor="nw",text_color='Black',fg_color='#dc4c4c',width=350)
        self.scan_detail_label.grid(row=0, column=0, pady=5, padx=5,sticky="nw")
        
        self.horizontal_line_label = ctk.CTkLabel(self.info_vulnerabilities, text="----------------------------------------------------",anchor="nw", font=ctk.CTkFont(size=20, weight="bold"),text_color='Black',fg_color='#dc4c4c',width=350)
        ...
        elapsed="5 minutes"
        self.policy_label = ctk.CTkLabel(self.info_vulnerabilities, text="Policy:      "+ policy_scan, font=ctk.CTkFont(size=15),anchor="nw",text_color='Black',fg_color='#dc4c4c',width=350)
        self.policy_label.grid(row=2, column=0, pady=5, padx=5,sticky="nw")
        
        self.status_label = ctk.CTkLabel(self.info_vulnerabilities, text="Status:     "+ status, font=ctk.CTkFont(size=15),anchor="nw",text_color='Black',fg_color='#dc4c4c',width=350)
        self.status_label.grid(row=3, column=0, pady=5, padx=5,sticky="nw")
        
        self.start_label = ctk.CTkLabel(self.info_vulnerabilities, text="Start:        "+ start, font=ctk.CTkFont(size=15),anchor="nw",text_color='Black',fg_color='#dc4c4c',width=350)
        self.start_label.grid(row=4, column=0, pady=5, padx=5,sticky="nw")
        
        self.end_label = ctk.CTkLabel(self.info_vulnerabilities, text="End:          "+ end, font=ctk.CTkFont(size=15),anchor="nw",text_color='Black',fg_color='#dc4c4c',width=350)
        self.end_label.grid(row=5, column=0, pady=5, padx=5,sticky="nw")
        
        self.elapsed_label = ctk.CTkLabel(self.info_vulnerabilities, text="Elapsed:   "+ elapsed, font=ctk.CTkFont(size=15),anchor="nw",text_color='Black',fg_color='#dc4c4c',width=350)
        self.elapsed_label.grid(row=6, column=0, pady=5, padx=5,sticky="nw")
        
        self.vul_detail_label = ctk.CTkLabel(self.info_vulnerabilities, text="Vulnerabilities", font=ctk.CTkFont(size=20, weight="bold"),anchor="nw",text_color='Black',fg_color='#dc4c4c',width=350)
        self.vul_detail_label.grid(row=7, column=0, pady=5, padx=5,sticky="nw")
        
        self.horizontal_line_label_1 = ctk.CTkLabel(self.info_vulnerabilities, text="----------------------------------------------------",anchor="nw", font=ctk.CTkFont(size=20, weight="bold"),text_color='Black',fg_color='#dc4c4c',width=350)
        ...
        self.high_color = ctk.CTkLabel(self.info_vulnerabilities, image=ctk.CTkImage(Image.open(current_path + "/assets/icons/round_red.jpg"),size=(30, 30)), text="High :      "+ str(high_severity), fg_color='#dc4c4c', compound="left", padx=5, anchor="w")
        self.high_color.grid(row=9, column=0, padx=5, pady=5, sticky="nw")
       
        
        self.medium_severity_label = ctk.CTkLabel(self.info_vulnerabilities, image=ctk.CTkImage(Image.open(current_path + "/assets/icons/round_blue.png"),size=(20, 20)), text="Medium :      "+ str(medium_severity), fg_color='#dc4c4c',text_color='blue', compound="left", padx=5, anchor="w")
        
        self.medium_severity_label.grid(row=10, column=0, pady=5, padx=5,sticky="nw")
        
        self.low_severity_label = ctk.CTkLabel(self.info_vulnerabilities, text="Low :      "+ str(low_severity), font=ctk.CTkFont(size=15),anchor="nw",text_color='Black',fg_color='#dc4c4c',width=350)
        self.low_severity_label.grid(row=11, column=0, pady=5, padx=5,sticky="nw")
        
        self.slide = ctk.CTkFrame(self,height=200, width=master.winfo_width(), fg_color="#2b2b2b")
